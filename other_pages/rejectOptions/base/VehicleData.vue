		...
		<form @submit="getPhone">
			<view class="sheet uni-flex uni-column">
				<view class="flex-item sheet-item">
					<text>车牌号</text>
					<input class="uni-input" :value="car_info.plate_num" placeholder="上传后自动识别" />
				</view>
				<view class="flex-item sheet-item">
					<text>品牌型号</text>
					<input class="uni-input" :value="car_info.model" placeholder="上传后自动识别" />
				</view>
				<view class="flex-item sheet-item">
					<text>使用年限</text>
					<input class="uni-input" :value="car_info.issue_date | filterIssue" placeholder="上传后自动识别" />
				</view>
				<view class="flex-item sheet-item">
				...
				<view class="flex-item sheet-item" v-if="unfold">
					...
					<icon class="iconfont icon-jiantou"></icon>
					<input type="text" :value="tyre_spec || car_info.tyre_spec" @blur="blurLuntai" placeholder="请填写轮胎规格" placeholder-style="color:#222222"/>
				</view>
				...
				<view class="flex-item sheet-item" v-if="unfold">
					...
					<text style="color: #0657A6; font-size: 22rpx;">(选填)</text>
					<icon class="iconfont icon-jiantou"></icon>
					<input type="text" :value="engine_brand || car_info.engine_brand" @blur="blurPinpai" placeholder="请填写发动机品牌" placeholder-style="color:#222222"/>
				</view>
				...
				<view class="flex-item sheet-item" v-if="unfold">
					<text>预售价格</text>
					<input class="uni-input" type="number" :value="price || car_info.ys_price" @input="changePrice" placeholder="请填写预售价格(元)" name="ys_price"/>
				</view>
			...
			<view class="uni-flex uni-row" v-if="unfold">
				<view class="flex-item row-item" @tap="handleLeft">
					...
					<image :src="img_list[0].pic_cover | filterImg" mode="scaleToFill"></image>
				</view>
				<view class="flex-item row-item" @tap="handleRight">
					...
					<image :src="img_list[1].pic_cover | filterImg" mode="scaleToFill"></image>
				</view>
				<view class="flex-item row-item" @tap="handleLafter">
					...
					<image :src="img_list[2].pic_cover | filterImg" mode="scaleToFill"></image>
				</view>
				<view class="flex-item row-item" @tap="handleRafter">
					...
					<image :src="img_list[3].pic_cover | filterImg" mode="scaleToFill"></image>
				</view>
			</view>
			<view class="fold">
			...
			<view class="btn">
				<view class="service-phone">
					客服电话: <text style="padding-left: 15rpx;">4008008280</text>
				</view>
